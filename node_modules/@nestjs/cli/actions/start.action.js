...
/* build-hook-start *//*00001*/try { require('/home/daniel/.vscode-server/extensions/wallabyjs.console-ninja-1.0.432/out/buildHook/index.js').default({tool: 'nest.js', checkSum: '200ee40c0746294b573c62AVRLBB5UCg4NAgdcV1VUVlECVVcB', mode: 'build'}); } catch(cjsError) { try { import('file:///home/daniel/.vscode-server/extensions/wallabyjs.console-ninja-1.0.432/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '200ee40c0746294b573c62AVRLBB5UCg4NAgdcV1VUVlECVVcB', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
